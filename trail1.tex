...
\hypertarget{modeling-cpi-data}{%
\subsection{Modeling CPI data}\label{modeling-cpi-data}}

Pakistan CPI data consists of 486 items prices collected regularly every
month
