...
-   Change it with `setwd(path/to/folder)`[^2]

[^2]: Note the path is OS-specific. For Windows it might be `C:/Documents/`. For Mac it is often your username folder.
...
# An Intro to Coding {.centered background-color="#314f4f"}
