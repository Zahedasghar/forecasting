---
title: "Tax Report for Services Sector in Punjab "
author: "Zahid Asghar"
...
In this section we are analysing each service share in percentage. We shall list top 10 sectors and it has been observed that their share is almost 65% in total tax from all 170 plus services included in the list.
...
## Forecasting for Service having Tax rate 16%
 Tax rate varies from service to service. In order to calculate total service tax collected we filter data for year 2021 and take two scenarios. One is where tax rate is 16% and other is total service tax collected at all the rates.
These numbers can used to calcualte impact of change in tax amount if rates are revised from those of prevailing rates.
```{r tax-rate, echo=FALSE}
